...
function renderGameOver() {
    ...
    var instruction = "Sentuh untuk bermain kembali.";
    context.font = "bold normal 24px sans-serif";
...
function renderInstructions() {
    var instruction = "Sentuh untuk memulai";
    context.font = "bold normal 24px sans-serif";
    context.fillStyle = "#FFFFFF";
...
function changeText() {
    ...
    if (textInput.value && textInput.text != "") {
        if (textInput.value.length > maxCharacters) {
            alert("Woy, jangan lewat dari " + maxCharacters + " karakter, ulang-ulang.");
            return;
        }
        if (textInput.value.indexOf(" ") > -1) {
            alert("Woy, jangan kelebihan dari 8 karakter :<");
            return;
        }
